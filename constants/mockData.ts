...
export const MOCK_STORES: PartnerStore[] = [
  ...
  },
  {
    ...
    distanceKm: 2.1,
    branchCount: 1,
    logo: foodImages.grocery.fruitStand,
  ...
  },
  {
    ...
    distanceKm: 1.8,
    branchCount: 2,
    logo: require('../assets/partners/green-cart-market.jpg'),
    ...
    bags: [
      ...
      },
      {
        ...
        left: 7,
        tags: ['Groceries'],
        image: foodImages.grocery.breadGrocery,
      },
      {
        id: 'gcm-yogurt-fruit',
        ...
        image: foodImages.grocery.dairyYogurt,
      },
    ],
  },
];
